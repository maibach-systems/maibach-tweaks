...
alias claudem="claude --dangerously-skip-permissions --effort max --model claude-opus-4-6[1m] $_csp"    # Max effort, Opus 1M
alias claudems="claude --dangerously-skip-permissions --effort high --model claude-sonnet-4-6 $_csp"     # High effort, Sonnet
alias claudeh="claude --dangerously-skip-permissions --effort high --model claude-opus-4-6[1m] $_csp"    # High effort, Opus 1M
alias claudeo="claude --dangerously-skip-permissions --model claude-opus-4-6[1m] $_csp"                  # Default effort, Opus 1M
